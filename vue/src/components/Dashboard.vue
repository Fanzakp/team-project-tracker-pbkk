  ...
  <div class="dashboard">
    ...
    <main class="main-content">
      ...
      <div v-if="selectedMenu === 'todaysAppointments'" class="today-section">
        ...
        <ul>
          <li v-for="appointment in todaysAppointments" :key="appointment.id">
            {{ appointment.title }}
          </li>
        </ul>
      </div>
...
const projects = ref([
  {
    id: 1,
    name: 'Not Started',
    description: 'Projects that has not been started yet',
    tasks: [
  ...
  },
  {
    id: 2,
    name: 'In Progress',
    description: 'In progress project that needed updates',
    tasks: [
  ...
  },
  {
    id: 3,
    name: 'Finished',
    description: 'Finished projects will showed here',
    tasks: [
...
const todaysTasks = computed(() => {
  ...
  return selectedProject.value
    ? selectedProject.value.tasks.filter(task => task.date === today)
    : []
})
...
const todaysAppointments = computed(() => {
  ...
  return appointments.value.filter(
    appointment => appointment.start.split('T')[0] === today,
  )
})
